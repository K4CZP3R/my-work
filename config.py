...
MONGO_HOST = os.environ[ConfigKeys.MONGO_HOST] if ConfigKeys.MONGO_HOST in os.environ else "mongodb://root:example" \
                                                                                           "@localhost"
...
TEMP_PATH = os.environ[ConfigKeys.TEMP_PATH] if ConfigKeys.TEMP_PATH in os.environ else ""
